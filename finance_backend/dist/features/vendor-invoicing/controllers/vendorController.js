...
exports.getVendorBankPaymentSheetBatch = exports.getVendorBankPaymentSheets = exports.saveVendorBankPaymentSheet = exports.ensureVendorBankPaymentSheetTable = exports.getVendorCNDNList = exports.saveVendorCNDN = exports.getVendorInvoicesList = exports.saveVendorInvoice = exports.getNextInvoiceNumber = exports.getVendorTrips = exports.getVendors = void 0;
    ...
    try {
      ...
      WHERE VendorID = ? OR VendorName = ? OR CompanyName = ?`, [vendorName, vendorName, vendorName]);
       ...
       ORDER BY 
         ...
         id DESC`, [actualVendorName, vendorName, actualVendorName, projIdVal, projIdVal, projIdVal, stateFilter, stateFilter, stateFilter, placementType]);
...
const ensureVendorBankPaymentSheetTable = async () => {
    try {
...
exports.ensureVendorBankPaymentSheetTable = ensureVendorBankPaymentSheetTable;
const saveVendorBankPaymentSheet = async (req, res) => {
    try {
        await (0, exports.ensureVendorBankPaymentSheetTable)();
...
exports.saveVendorBankPaymentSheet = saveVendorBankPaymentSheet;
const getVendorBankPaymentSheets = async (req, res) => {
    try {
        await (0, exports.ensureVendorBankPaymentSheetTable)();
        const [rows] = await database_1.db.query(`
      SELECT 
...
exports.getVendorBankPaymentSheets = getVendorBankPaymentSheets;
const getVendorBankPaymentSheetBatch = async (req, res) => {
    try {
        await (0, exports.ensureVendorBankPaymentSheetTable)();
        const { batchId } = req.params;
        const [rows] = await database_1.db.query(`SELECT * FROM VendorBankPaymentSheet WHERE batch_id = ? ORDER BY id ASC`, [batchId]);
        res.json(rows);
    }
    catch (error) {
...
exports.getVendorBankPaymentSheetBatch = getVendorBankPaymentSheetBatch;
