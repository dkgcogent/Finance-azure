  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        // Custom variants for Invoice Master
        ...
        customer: "border-transparent bg-blue-100 text-blue-700 hover:bg-blue-200",
        vendor: "border-transparent bg-purple-100 text-purple-700 hover:bg-purple-200",
      },
    },
    defaultVariants: {
      variant: "default",
